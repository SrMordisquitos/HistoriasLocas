"""
Proyecto de Python / Historias Locas).
...
organización = "Viberth" # Cadena de caracteres asignada a una variable.
...
¡Aprende a {verbo2} con Viberth y alcanza tus {sustantivo_plural}!"
